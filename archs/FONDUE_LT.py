...
class FONDUE(nn.Module):
    ...
    def forward(self, input, orig_zoom):
        ...
        x0_02 = torch.nn.functional.interpolate(x0_0, size=inner_shape, mode=interp_mode, align_corners=None, recompute_scale_factor=None)
        ...
        #Diagonal_inferior
        c2 = torch.nn.functional.interpolate(x1_0, size=orig_shape, mode=interp_mode, align_corners=None, recompute_scale_factor=None)
        ...
        c2 = torch.unsqueeze(c2,4)
        #Diagonal inferior:
        c3 = torch.nn.functional.interpolate(x1_1, size=orig_shape, mode=interp_mode, align_corners=None, recompute_scale_factor=None)
        ...
        c2 = x0_1
        c3 = x0_2
        c4 = torch.nn.functional.interpolate(x1_2, size=orig_shape, mode=interp_mode, align_corners=None, recompute_scale_factor=None)
        c1 = torch.unsqueeze(c1,4)
        c2 = torch.unsqueeze(c2,4)
        c3 = torch.unsqueeze(c3,4)
        ...
        c3 = x0_2
        c4 = x0_3
        c5 = torch.nn.functional.interpolate(x1_3, size=orig_shape, mode=interp_mode, align_corners=None, recompute_scale_factor=None)
        c1 = torch.unsqueeze(c1,4)
        c2 = torch.unsqueeze(c2,4)
        c3 = torch.unsqueeze(c3,4)
        c4 = torch.unsqueeze(c4,4)
        ...
        c6 = torch.nn.functional.interpolate(x1_4, size=orig_shape, mode=interp_mode, align_corners=None, recompute_scale_factor=None)
        c1 = torch.unsqueeze(c1,4)
        c2 = torch.unsqueeze(c2,4)
        c3 = torch.unsqueeze(c3,4)
        c4 = torch.unsqueeze(c4,4)
        ...
        c7 = torch.nn.functional.interpolate(x1_5, size=orig_shape, mode=interp_mode, align_corners=None, recompute_scale_factor=None)
        c1 = torch.unsqueeze(c1,4)
        c2 = torch.unsqueeze(c2,4)
        c3 = torch.unsqueeze(c3,4)
        c4 = torch.unsqueeze(c4,4)
